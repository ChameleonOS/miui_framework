...
public class GLES11 extends GLES10 {
    ...
    public static native void glClipPlanef(int i, float af[], int j);

    public static native void glClipPlanex(int i, IntBuffer intbuffer);

    public static native void glClipPlanex(int i, int ai[], int j);

    public static native void glColor4ub(byte byte0, byte byte1, byte byte2, byte byte3);

    public static native void glColorPointer(int i, int j, int k, int l);
    ...
    public static native void glGetClipPlanef(int i, float af[], int j);

    public static native void glGetClipPlanex(int i, IntBuffer intbuffer);

    public static native void glGetClipPlanex(int i, int ai[], int j);

    public static native void glGetFixedv(int i, IntBuffer intbuffer);

    public static native void glGetFixedv(int i, int ai[], int j);
    ...
    public static native void glGetLightfv(int i, int j, FloatBuffer floatbuffer);

    public static native void glGetLightfv(int i, int j, float af[], int k);

    public static native void glGetLightxv(int i, int j, IntBuffer intbuffer);

    public static native void glGetLightxv(int i, int j, int ai[], int k);

    public static native void glGetMaterialfv(int i, int j, FloatBuffer floatbuffer);

    public static native void glGetMaterialfv(int i, int j, float af[], int k);

    public static native void glGetMaterialxv(int i, int j, IntBuffer intbuffer);

    public static native void glGetMaterialxv(int i, int j, int ai[], int k);

    public static native void glGetTexEnvfv(int i, int j, FloatBuffer floatbuffer);

    public static native void glGetTexEnvfv(int i, int j, float af[], int k);

    public static native void glGetTexEnviv(int i, int j, IntBuffer intbuffer);

    public static native void glGetTexEnviv(int i, int j, int ai[], int k);

    public static native void glGetTexEnvxv(int i, int j, IntBuffer intbuffer);

    public static native void glGetTexEnvxv(int i, int j, int ai[], int k);
    ...
    public static native void glGetTexParameterxv(int i, int j, IntBuffer intbuffer);

    public static native void glGetTexParameterxv(int i, int j, int ai[], int k);
    ...
    public static native void glNormalPointer(int i, int j, int k);
    ...
    public static native void glPointParameterfv(int i, float af[], int j);

    public static native void glPointParameterx(int i, int j);

    public static native void glPointParameterxv(int i, IntBuffer intbuffer);

    public static native void glPointParameterxv(int i, int ai[], int j);

    public static void glPointSizePointerOES(int i, int j, Buffer buffer) {
        glPointSizePointerOESBounds(i, j, buffer, buffer.remaining());
        if((i == 5126 || i == 5132) && j >= 0)
            _pointSizePointerOES = buffer;
    }

    private static native void glPointSizePointerOESBounds(int i, int j, Buffer buffer, int k);

    public static native void glTexCoordPointer(int i, int j, int k, int l);

    public static native void glTexEnvi(int i, int j, int k);

    public static native void glTexEnviv(int i, int j, IntBuffer intbuffer);

    public static native void glTexEnviv(int i, int j, int ai[], int k);
    ...
    public static native void glTexParameterxv(int i, int j, IntBuffer intbuffer);

    public static native void glTexParameterxv(int i, int j, int ai[], int k);

    public static native void glVertexPointer(int i, int j, int k, int l);
