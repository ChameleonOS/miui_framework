...
public class MiuiVolumePreference extends SeekBarDialogPreference
    ...
    public class SeekBarVolumizer
        ...
        final MiuiVolumePreference this$0;
        ...
        public SeekBarVolumizer(Context context, SeekBar seekbar, int i, Uri uri) {
            this$0 = MiuiVolumePreference.this;
            super();
                ...
                public void onChange(boolean flag) {
                    ...
                    if(mSeekBar != null && mAudioManager != null) {
                        ...
                        if(mAudioManager.isStreamMute(mStreamType))
                            j = mAudioManager.getLastAudibleStreamVolume(mStreamType);
                        else
                            j = mAudioManager.getStreamVolume(mStreamType);
    ...
    public MiuiVolumePreference(Context context, AttributeSet attributeset) {
        super(context, attributeset);
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, android.R.styleable.VolumePreference, 0, 0);
    ...
    private void cleanup() {
        ...
        if(mSeekBarVolumizer != null) {
            ...
            if(dialog != null && dialog.isShowing()) {
                View view = dialog.getWindow().getDecorView().findViewById(0x60b0012);
                if(view != null)
    ...
    protected void onBindDialogView(View view) {
        ...
        SeekBar seekbar = (SeekBar)view.findViewById(0x60b0012);
...
_L3:
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        if(parcelable != null && parcelable.getClass().equals(android/preference/MiuiVolumePreference$SavedState)) goto _L2; else goto _L1
_L1:
