        ...
        public static IOnKeyguardExitResult asInterface(IBinder ibinder) {
            ...
            if(ibinder == null) {
                ...
                if(iinterface != null && (iinterface instanceof IOnKeyguardExitResult))
                    obj = (IOnKeyguardExitResult)iinterface;
                else
                    obj = new Proxy(ibinder);
            }
            return ((IOnKeyguardExitResult) (obj));
        }
...
_L4:
    ...
    public abstract void onKeyguardExitResult(boolean flag) throws RemoteException;
}
