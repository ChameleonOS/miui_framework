...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attributeset) {
        ...
        mBitmapBtnDefault = getBitmapFor(0x1080117);
        mBitmapBtnTouched = getBitmapFor(0x1080119);
        mBitmapCircleDefault = getBitmapFor(0x108036f);
        mBitmapCircleGreen = getBitmapFor(0x1080371);
        mBitmapCircleRed = getBitmapFor(0x1080373);
        mBitmapArrowGreenUp = getBitmapFor(0x108036c);
        mBitmapArrowRedUp = getBitmapFor(0x108036d);
