...
public interface GL11
    ...
    public abstract void glBindBuffer(int i, int j);

    public abstract void glBufferData(int i, int j, Buffer buffer, int k);

    public abstract void glBufferSubData(int i, int j, int k, Buffer buffer);

    public abstract void glClipPlanef(int i, FloatBuffer floatbuffer);

    public abstract void glClipPlanef(int i, float af[], int j);

    public abstract void glClipPlanex(int i, IntBuffer intbuffer);

    public abstract void glClipPlanex(int i, int ai[], int j);

    public abstract void glColor4ub(byte byte0, byte byte1, byte byte2, byte byte3);

    public abstract void glColorPointer(int i, int j, int k, int l);

    public abstract void glDeleteBuffers(int i, IntBuffer intbuffer);

    public abstract void glDeleteBuffers(int i, int ai[], int j);

    public abstract void glDrawElements(int i, int j, int k, int l);

    public abstract void glGenBuffers(int i, IntBuffer intbuffer);

    public abstract void glGenBuffers(int i, int ai[], int j);

    public abstract void glGetBooleanv(int i, IntBuffer intbuffer);

    public abstract void glGetBooleanv(int i, boolean aflag[], int j);

    public abstract void glGetBufferParameteriv(int i, int j, IntBuffer intbuffer);

    public abstract void glGetBufferParameteriv(int i, int j, int ai[], int k);

    public abstract void glGetClipPlanef(int i, FloatBuffer floatbuffer);

    public abstract void glGetClipPlanef(int i, float af[], int j);

    public abstract void glGetClipPlanex(int i, IntBuffer intbuffer);

    public abstract void glGetClipPlanex(int i, int ai[], int j);

    public abstract void glGetFixedv(int i, IntBuffer intbuffer);

    public abstract void glGetFixedv(int i, int ai[], int j);

    public abstract void glGetFloatv(int i, FloatBuffer floatbuffer);

    public abstract void glGetFloatv(int i, float af[], int j);

    public abstract void glGetLightfv(int i, int j, FloatBuffer floatbuffer);

    public abstract void glGetLightfv(int i, int j, float af[], int k);

    public abstract void glGetLightxv(int i, int j, IntBuffer intbuffer);

    public abstract void glGetLightxv(int i, int j, int ai[], int k);

    public abstract void glGetMaterialfv(int i, int j, FloatBuffer floatbuffer);

    public abstract void glGetMaterialfv(int i, int j, float af[], int k);

    public abstract void glGetMaterialxv(int i, int j, IntBuffer intbuffer);

    public abstract void glGetMaterialxv(int i, int j, int ai[], int k);

    public abstract void glGetPointerv(int i, Buffer abuffer[]);

    public abstract void glGetTexEnviv(int i, int j, IntBuffer intbuffer);

    public abstract void glGetTexEnviv(int i, int j, int ai[], int k);

    public abstract void glGetTexEnvxv(int i, int j, IntBuffer intbuffer);

    public abstract void glGetTexEnvxv(int i, int j, int ai[], int k);

    public abstract void glGetTexParameterfv(int i, int j, FloatBuffer floatbuffer);

    public abstract void glGetTexParameterfv(int i, int j, float af[], int k);

    public abstract void glGetTexParameteriv(int i, int j, IntBuffer intbuffer);

    public abstract void glGetTexParameteriv(int i, int j, int ai[], int k);

    public abstract void glGetTexParameterxv(int i, int j, IntBuffer intbuffer);

    public abstract void glGetTexParameterxv(int i, int j, int ai[], int k);
    ...
    public abstract void glNormalPointer(int i, int j, int k);

    public abstract void glPointParameterf(int i, float f);

    public abstract void glPointParameterfv(int i, FloatBuffer floatbuffer);

    public abstract void glPointParameterfv(int i, float af[], int j);

    public abstract void glPointParameterx(int i, int j);

    public abstract void glPointParameterxv(int i, IntBuffer intbuffer);

    public abstract void glPointParameterxv(int i, int ai[], int j);

    public abstract void glPointSizePointerOES(int i, int j, Buffer buffer);

    public abstract void glTexCoordPointer(int i, int j, int k, int l);

    public abstract void glTexEnvi(int i, int j, int k);

    public abstract void glTexEnviv(int i, int j, IntBuffer intbuffer);

    public abstract void glTexEnviv(int i, int j, int ai[], int k);

    public abstract void glTexParameterfv(int i, int j, FloatBuffer floatbuffer);

    public abstract void glTexParameterfv(int i, int j, float af[], int k);

    public abstract void glTexParameteri(int i, int j, int k);

    public abstract void glTexParameteriv(int i, int j, IntBuffer intbuffer);

    public abstract void glTexParameteriv(int i, int j, int ai[], int k);

    public abstract void glTexParameterxv(int i, int j, IntBuffer intbuffer);

    public abstract void glTexParameterxv(int i, int j, int ai[], int k);

    public abstract void glVertexPointer(int i, int j, int k, int l);
