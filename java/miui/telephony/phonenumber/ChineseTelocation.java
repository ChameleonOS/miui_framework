...
_L2:
        ...
        mFile.read(abyte1);
        if("5d7ebb69313ba6cd22601ea82f734d69fdd22063".equals(new String(abyte1)))
...
_L3:
    ...
    static  {
        FILE_HEADER_SIZE = 0 + (4 + (4 + (4 + TelocationConstants.FILE_TAG.length + "5d7ebb69313ba6cd22601ea82f734d69fdd22063".getBytes().length)));
