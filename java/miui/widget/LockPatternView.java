...
_L2:
    ...
    private void loadAttrs(Context context, AttributeSet attributeset) {
        ...
        mBitmapBtnDefaultWithBackground = getBitmapFor(typedarray.getResourceId(4, 0x60201e3));
        mBitmapBtnDefault = getBitmapFor(typedarray.getResourceId(3, 0x60201dc));
        mBitmapBtnTouched = getBitmapFor(typedarray.getResourceId(5, 0x60201dd));
        mBitmapCircleDefault = getBitmapFor(typedarray.getResourceId(6, 0x60201de));
        mBitmapCircleGreen = getBitmapFor(typedarray.getResourceId(7, 0x60201df));
        mBitmapCircleRed = getBitmapFor(typedarray.getResourceId(8, 0x60201e0));
        mBitmapArrowGreenUp = getBitmapFor(typedarray.getResourceId(9, 0x60201e1));
        mBitmapArrowRedUp = getBitmapFor(typedarray.getResourceId(10, 0x60201e2));
